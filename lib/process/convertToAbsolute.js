...
module.exports.processConvertToAbsolute = function (ruta) {
  return path.resolve(ruta); // console.log(path.resolve(ruta));
}; // no relacionar funciones con estos archivos no se podrà testear
// y no ponerno en la funcion proncipal asi como todas no se testea