...
// paso4
var ruta = "C:\\Users\\Rocio Soledad\\Desktop\\LIM009-fe-md-links\\LIM009-fe-md-links\\Readme.md"; // // const ruta='/test/demo_path.js'; //ruta absoluta=true
...
var ab = require('../process/absolute');

var ac = require('../process/convertToAbsolute');

var de = require('../process/fileOrDirectory');

var ef = require('../process/isMarkdown');

var gh = require('../process/readFile');

var ij = require('../process/arrayOfMarkdowns');

var kl = require('../process/extractLinksOfMarkdowns');

var mdLinks = function mdLinks(path, options) {
  console.log(ab.pathAbsolute(path) + " es absoluta ");
  var convertir = ab.pathAbsolute(path);

  if (convertir === false) {
    console.log(ac.processConvertToAbsolute(path) + "se convirtió en absoluta"); // console.log("se convirtió en absoluta");
